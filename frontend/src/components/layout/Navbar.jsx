      ...
      >
        <div className="mx-auto max-w-[1440px] px-5 sm:px-8 h-16 flex items-center justify-between gap-4">
          <Link to="/" data-testid="nav-logo" className="flex items-center gap-3 group">
            <span className="font-mono text-sm font-bold tracking-[0.15em] text-ink">{settings.siteName}</span>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              to="/contact"
              data-testid="nav-cta"
              className="hidden sm:inline-flex h-9 items-center px-4 bg-violet font-mono text-[11px] tracking-[0.15em] uppercase font-semibold hover:opacity-90 transition-opacity"
              style={{ color: "var(--bg)" }}
            >
              Let's Work →
            </Link>
        ...
        {open && (
          ...
          >
            ...
            <div className="px-5 py-6 border-t border-line flex items-center justify-between">
              <button data-testid="mobile-theme-toggle" onClick={cycle}
